...
At first glance, the most significant predictor would be the review itself. However, as the review is comprised of text it becomes difficult to implement in a regression model. To 
